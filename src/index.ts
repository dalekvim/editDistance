...
const editDistance = (pattern: String, text: String): number => {
...
// The following is an example from a lecture series I followed on DNA sequencing.
console.log(editDistance("GCGTATGC", "TATTGGCTATACGGTT")); // Returns 2.
